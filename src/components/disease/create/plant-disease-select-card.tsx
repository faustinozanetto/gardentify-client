...
interface PlantDiseaseSelectCardProps {
  disease?: Disease;
  loading?: boolean;
  onClick: () => void;
}

const PlantDiseaseSelectCard: React.FC<PlantDiseaseSelectCardProps> = (props) => {
  const { disease, loading, onClick } = props;
...
export default PlantDiseaseSelectCard;
